				...
				c("#" + h.queueID)
						.append(
								'<div id="'
										...
										+ " ("
										+ i
										+ ')</span><span class="data"></span>					<div class="uploadify-progress">						<div class="uploadify-progress-bar"><!--Progress Bar--></div>					</div>				<span class="op"></span></div>');
			}
			...
			if (c.inArray("onUploadComplete", g.overrideEvents) < 0) {
				if (g.removeCompleted) {
					c("#" + f.id).attr("fid", json.fid);
                                        c("#" + f.id).find('span.op').append('<a href="#" onclick="addDesc('+json.fid+')">ÃÌº”ªÚ–ﬁ∏ƒ√Ë ˆ</a>&nbsp;&nbsp;&nbsp;&nbsp;');
					switch (f.filestatus) {
